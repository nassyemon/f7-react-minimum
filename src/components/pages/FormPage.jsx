  ...
  <Page>
    ...
    <List form>
      ...
      <ListItem title="Toggle">
        <Toggle
          slot="after"
          onToggleChange={onToggleUpdated}
          checked={toggle}
        />
      </ListItem>
      <ListItem>
        ...
        <Input>
          <Range
            ...
            step="1"
            label
            onRangeChanged={value => onSliderUpdated(value)}
          />
        </Input>
      </ListItem>
      <ListItem>
    ...
    <Block strong>
      ...
      <Row tag="p">
        <Button className="col" big raised>
          Big
        </Button>
        <Button className="col" big fill raised>
          Big Fill
        </Button>
      </Row>
      <Row tag="p">
        <Button className="col" big fill raised color="red">
          Big Red
        </Button>
        <Button className="col" big fill raised color="green">
          Big Green
        </Button>
      </Row>
    </Block>
